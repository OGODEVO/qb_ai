...
from tools.sportradar import get_tools as get_sportradar_tools, get_daily_schedule, get_game_boxscore, get_live_stat
...
def get_tools_and_available_functions():
    ...
    available_tools["get_live_stat"] = get_live_stat
