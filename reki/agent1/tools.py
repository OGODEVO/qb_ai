...
from tools.sportradar import get_tools as get_sportradar_tools, get_daily_schedule, get_live_game_stats, get_game_boxscore
...
def get_tools_and_available_functions():
    ...
    available_tools["get_live_game_stats"] = get_live_game_stats
